...
//Reminder: RoundCounterBluBG and RoundCounterRedBG are lines created by Mr. Anchois

  "RoundCounterRedBG"
  {
    "ControlName"   "ImagePanel"
    "fieldName"     "RoundCounterRedBG"
    "xpos"          "427"
    "ypos"          "-2"
    "zpos"          "-1"
    "wide"          "40"
  ...
  "RoundCounterBluBG"
  {
	...
	"TeamStatus"
	{
      ...
      "ypos"      "0"
			...
			"color_bar_health_high"	"0 155 78 255"
			...
			"respawntime"     //animations are in hudanim
			{
				"ControlName"	"CExLabel"
      ...
      "respawntimeShadow"
        ...
        "pin_to_sibling_corner"	"PIN_TOPLEFT"
			...
			"DeathPanel"    //animations are in hudanim
			{
				"ControlName"	"ImagePanel"
			...
			"SkullPanel"      //animations are in hudanim
			{
				"ControlName"	"ImagePanel"
				"fieldName"		"SkullPanel"
				"xpos"			"cs-0.5" //old cs-0.5
				"zpos"			"1"
				"wide"			"o1.2"
				"tall"			"p0.15"
				"visible"		"0"
